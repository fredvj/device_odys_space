...
PRODUCT_COPY_FILES += \
	device/odys/space/prebuilt/adreno200/lib/egl/eglsubAndroid.so:system/lib/egl/eglsubAndroid.so \
	device/odys/space/prebuilt/adreno200/lib/egl/libEGL_adreno200.so:system/lib/egl/libEGL_adreno200.so \
	device/odys/space/prebuilt/adreno200/lib/egl/libGLESv1_CM_adreno200.so:system/lib/egl/libGLESv1_CM_adreno200.so \
	device/odys/space/prebuilt/adreno200/lib/egl/libGLESv2_adreno200.so:system/lib/egl/libGLESv2_adreno200.so \
	device/odys/space/prebuilt/adreno200/lib/egl/libq3dtools_adreno200.so:system/lib/egl/libq3dtools_adreno200.so \
	device/odys/space/prebuilt/adreno200/lib/libC2D2.so:system/lib/libC2D2.so \
	device/odys/space/prebuilt/adreno200/lib/libgsl.so:system/lib/libgsl.so \
	device/odys/space/prebuilt/adreno200/lib/libOpenVG.so:system/lib/libOpenVG.so \
	device/odys/space/prebuilt/adreno200/lib/libsc-a2xx.so:system/lib/libsc-a2xx.so
...
PRODUCT_COPY_FILES += \
        device/odys/space/prebuilt/adreno200/etc/firmware/leia_pfp_470.fw:system/etc/firmware/leia_pfp_470.fw \
        device/odys/space/prebuilt/adreno200/etc/firmware/leia_pm4_470.fw:system/etc/firmware/leia_pm4_470.fw \
	device/odys/space/prebuilt/adreno200/etc/firmware/yamato_pm4.fw:system/etc/firmware/yamato_pm4.fw \
	device/odys/space/prebuilt/adreno200/etc/firmware/yamato_pfp.fw:system/etc/firmware/yamato_pfp.fw \
